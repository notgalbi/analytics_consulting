...
# Sources: MGMA, HFMA, WordStream, HubSpot, Bessemer, OpenView, Shopify, NRF,
#          SHRM, Gallup, LinkedIn, NRA, Toast, NAR, HDI, Zendesk, SMA, D&B, CMS
_KPI_BENCHMARKS: dict[str, dict[str, dict]] = {
    "marketing": {
        "CTR":             {"direction": "higher", "good": 3.0,   "warn": 1.0,  "note": "WordStream 2024: avg 2–5%; <1% = poor ad creative or targeting"},
        "ROAS":            {"direction": "higher", "good": 4.0,   "warn": 2.0,  "note": "Google/Meta 2024: >4x = healthy; <2x = unprofitable for most margin structures"},
        "Conversion Rate": {"direction": "higher", "good": 5.0,   "warn": 2.0,  "note": "HubSpot 2024: top quartile >5%; avg 2–5%; <2% = landing page or offer gap"},
        "CPC":             {"direction": "lower",  "good": 2.0,   "warn": 8.0,  "note": "WordStream 2024: avg $2–4 (Google Search); >$8 = inefficient paid traffic"},
        "CPA":             {"direction": "lower",  "good": 50.0,  "warn": 150.0,"note": "HubSpot 2024: varies by industry; <$50 = strong; >$150 = acquisition cost concern"},
    },
    "sales": {
        "MoM Revenue Growth": {"direction": "higher", "good": 5.0,   "warn": 0.0,  "note": "McKinsey 2024: healthy SMB >5% MoM; flat/declining = demand or pipeline issue"},
        "Avg Discount":       {"direction": "lower",  "good": 10.0,  "warn": 20.0, "note": "SMA 2024: keep below 15% to protect margins; >20% = systematic discounting risk"},
        "Avg Order Value":    {"direction": "higher", "good": 150.0, "warn": 50.0, "note": "Higher AOV = lower cost to serve per transaction; benchmark varies by category"},
    },
    "saas": {
        "Churn Rate":          {"direction": "lower",  "good": 2.0,  "warn": 5.0,  "note": "Bessemer Cloud Index 2024: <2% monthly = healthy; >5% = product-market fit risk"},
        "Avg NPS Score":       {"direction": "higher", "good": 7.0,  "warn": 5.0,  "note": "NPS 0–10 scale: Promoters ≥9, Passives 7–8; <5 = detractor-heavy, churn risk"},
        "MoM MRR Growth":      {"direction": "higher", "good": 10.0, "warn": 0.0,  "note": "Bessemer T2D3: early SaaS target ≥10% MoM; >0% = positive growth trajectory"},
        "Avg Contract Length": {"direction": "higher", "good": 12.0, "warn": 6.0,  "note": "OpenView 2024: annual contracts (≥12 mo) reduce churn exposure vs month-to-month"},
        "Revenue per Seat":    {"direction": "higher", "good": 50.0, "warn": 20.0, "note": "OpenView 2024: SMB target $20–50/seat/mo; Enterprise $100+; low = pricing opportunity"},
    },
    "ecommerce": {
        "Return Rate":        {"direction": "lower",  "good": 10.0, "warn": 20.0, "note": "Shopify 2024: industry avg 17%; <10% = strong product-market fit; >20% = margin risk"},
        "Avg Discount":       {"direction": "lower",  "good": 15.0, "warn": 25.0, "note": "IRP Commerce 2024: avg discount >20% = systematic margin erosion; review promo mix"},
        "Avg Days to Ship":   {"direction": "lower",  "good": 3.0,  "warn": 7.0,  "note": "Shopify 2024: customers expect ≤3 days post-Amazon; >7 days = abandonment driver"},
        "MoM Revenue Growth": {"direction": "higher", "good": 5.0,  "warn": 0.0,  "note": "eCommerce avg 10–15% YoY; MoM flat or declining = demand or competitive issue"},
        "Avg Order Value":    {"direction": "higher", "good": 75.0, "warn": 30.0, "note": "Shopify 2024: avg AOV $85–110; <$30 = limited upsell or bundling opportunity"},
    },
    "retail": {
        "Avg Gross Margin":   {"direction": "higher", "good": 45.0, "warn": 30.0, "note": "NRF 2024: specialty retail 45–65%; <30% = commodity pricing or cost structure issue"},
        "Stockout Rate":      {"direction": "lower",  "good": 5.0,  "warn": 10.0, "note": "NRF 2024: >8% stockout costs ~4% annual sales; target <5% to capture demand"},
        "Inventory Turnover": {"direction": "higher", "good": 0.5,  "warn": 0.2,  "note": "Monthly: >0.5x = healthy sell-through; <0.2x = dead stock and cash flow risk"},
        "Avg Days Cover":     {"direction": "lower",  "good": 45.0, "warn": 90.0, "note": "Target 30–60 days of stock cover; >90 days = overstock and working capital tied up"},
    },
    "hr": {
        "Attrition Rate":  {"direction": "lower",  "good": 10.0, "warn": 20.0, "note": "SHRM 2024: avg voluntary turnover 17%; target <10%; >20% = culture or compensation gap"},
        "Avg Performance": {"direction": "higher", "good": 3.5,  "warn": 2.5,  "note": "5-point scale: >3.5 = meeting expectations; <2.5 = systemic performance or mgmt issue"},
        "Avg Tenure":      {"direction": "higher", "good": 3.0,  "warn": 1.5,  "note": "LinkedIn 2024: avg tenure 3.7 yrs; <1.5 yrs = high early attrition or onboarding gap"},
        "Remote %":        {"direction": "higher", "good": 30.0, "warn": 10.0, "note": "Gallup 2024: 30–50% hybrid/remote is market norm; <10% = below flexibility expectations"},
    },
    "real_estate": {
        "Avg Days on Market": {"direction": "lower",  "good": 30.0, "warn": 60.0, "note": "NAR 2024: national median 26 days; >60 days = buyer's market or pricing above demand"},
        "List-to-Sale Ratio": {"direction": "higher", "good": 97.0, "warn": 93.0, "note": "NAR 2024: 100% = full asking price; >97% = strong demand; <93% = price reductions common"},
        "Sale Rate":          {"direction": "higher", "good": 85.0, "warn": 70.0, "note": "NAR 2024: >85% listing close rate = healthy pipeline; <70% = qualification or inventory issue"},
    },
    "hospitality": {
        "Food Cost %":        {"direction": "lower",  "good": 30.0, "warn": 38.0, "note": "NRA 2024: target 28–35%; >38% = menu pricing, portion control, or waste issue"},
        "Labor Cost %":       {"direction": "lower",  "good": 32.0, "warn": 38.0, "note": "Toast 2024: target 25–35%; >38% = overstaffing or wage pressure vs revenue"},
        "Prime Cost %":       {"direction": "lower",  "good": 60.0, "warn": 70.0, "note": "NRA: target <65%; 65–70% = watch zone; >70% = financially unsustainable"},
        "No-Show Rate":       {"direction": "lower",  "good": 5.0,  "warn": 10.0, "note": "Toast 2024: >5% no-shows = covers and revenue lost; deposit policy recommended"},
        "MoM Revenue Growth": {"direction": "higher", "good": 5.0,  "warn": 0.0,  "note": "NRA 2024: healthy restaurants track 5–10% YoY; flat or declining = demand concern"},
        "Avg Check Size":     {"direction": "higher", "good": 25.0, "warn": 15.0, "note": "Toast 2024: casual dining avg $18–25/cover; <$15 = upsell or menu mix opportunity"},
    },
    "healthcare": {
        "No-Show Rate":         {"direction": "lower",  "good": 8.0,   "warn": 15.0,  "note": "MGMA 2024: target <8%; >15% = scheduling and revenue integrity issue"},
        "Patient Satisfaction": {"direction": "higher", "good": 4.0,   "warn": 3.5,   "note": "CMS HCAHPS: >4.0/5 = strong retention; <3.5 = non-return and referral risk"},
        "Avg Wait Time":        {"direction": "lower",  "good": 15.0,  "warn": 30.0,  "note": "AHRQ 2024: target <15 min; >30 min = satisfaction drop and appointment abandonment"},
        "Completion Rate":      {"direction": "higher", "good": 90.0,  "warn": 80.0,  "note": "HFMA 2024: target >90%; <80% = significant unbilled revenue and scheduling gap"},
        "Avg Billing per Appt": {"direction": "higher", "good": 300.0, "warn": 150.0, "note": "MGMA 2024: primary care avg $300–450/visit; low billing = procedure mix or coding issue"},
    },
    "operations": {
        "Avg Response Time":   {"direction": "lower",  "good": 8.0,  "warn": 24.0, "note": "HDI 2024: top quartile first response <4 hrs; >24 hrs = SLA breach and CSAT risk"},
        "Avg Resolution Time": {"direction": "lower",  "good": 24.0, "warn": 72.0, "note": "Zendesk 2024: top quartile resolution <24 hrs; >72 hrs = customer churn signal"},
        "Resolution Rate":     {"direction": "higher", "good": 85.0, "warn": 70.0, "note": "HDI 2024: >85% first-contact resolution = efficient team; <70% = routing or skill gap"},
    },
    "finance": {
        "Margin":         {"direction": "higher", "good": 10.0, "warn": 5.0,  "note": "D&B 2024: industry median net margin 5–15%; <5% = thin or at-risk profitability"},
        "Net Profit":     {"direction": "higher", "good": 0.0,  "warn": 0.0,  "note": "Positive net profit = operational sustainability; negative = structural cost issue"},
    },
}
